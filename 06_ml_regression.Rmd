...
```{block, type = "rmdnote"}
RMSE and $R^2$ are performance metrics used for regression models. 

RMSE is a measure of the difference between the predicted and observed values; if the model fits the data well, RMSE is lower. To compute RMSE, you take the mean values of the squared difference between the predicted and observed values, then take the square root. 
